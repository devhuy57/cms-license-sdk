 ...
 */
export class InstallationForbiddenError extends Error {
  constructor(
    message: string,
...
export const LICENSE_KEY_SOURCE = Symbol('UPDATE_CLIENT_LICENSE_KEY_SOURCE');
...
export const INSTALLED_VERSION_PROVIDER = Symbol(
  'UPDATE_CLIENT_INSTALLED_VERSION_PROVIDER',
);
