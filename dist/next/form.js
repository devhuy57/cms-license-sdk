...
exports.renderActivationForm = renderActivationForm;
 ...
 */
function renderActivationForm(opts) {
    ...
    const support = opts.supportContact
        ...
        : '';
    const message = esc(opts.message ?? 'This installation needs a valid license to continue.');
