...
export type LicenseClientReason = 'no_token' | 'bad_signature' | 'product_mismatch' | 'feature_missing' | 'license_expired' | 'server_invalid' | 'offline_no_cache' | 'offline_grace_expired';
